...
define([
    ...
    , 'app/_common/common.module', 'app/auth/auth.module', 'app/admin/admin.module', 'app/blog/blog.module'

], function (ng) {

    //all angular common vendors module
    var angularModule = [, APP_MODULES.COMMON.name, APP_MODULES.AUTH.name, APP_MODULES.ADMIN.name, APP_MODULES.BLOG.name
